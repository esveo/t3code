...
contextBridge.exposeInMainWorld("desktopBridge", {
  ...
  readClipboardText: () => ipcRenderer.invoke(IpcChannels.READ_CLIPBOARD_TEXT_CHANNEL, undefined),
  ...
  restartForkService: () => ipcRenderer.invoke(IpcChannels.FORK_SERVICE_RESTART_CHANNEL),
