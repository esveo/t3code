...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Countdown to the provider's prompt-cache expiry in the composer footer.
  promptCacheIndicatorEnabled: Schema.Boolean.pipe(
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  promptCacheIndicatorEnabled: Schema.optionalKey(Schema.Boolean),
